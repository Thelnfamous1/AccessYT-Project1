...
public class AccessModKeybindings {
    ...
    public static final KeyBinding GOBBLEFIN_VORTEX = new KeyBinding(GOBBLEFIN_VORTEX_KEY, GLFW.GLFW_KEY_V, "key.categories.gameplay");

    public static final String GOBBLEFIN_BOOST_KEY = String.format("key.%s.gobblefin_boost", AccessMod.MODID);
    public static final KeyBinding GOBBLEFIN_BOOST = new KeyBinding(GOBBLEFIN_BOOST_KEY, GLFW.GLFW_KEY_LEFT_CONTROL, "key.categories.gameplay");
}
